...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoalEntity&&(identical(other.targetId, targetId) || other.targetId == targetId)&&(identical(other.targetValue, targetValue) || other.targetValue == targetValue)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.status, status) || other.status == status)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.goalNote, goalNote) || other.goalNote == goalNote)&&(identical(other.id, id) || other.id == id));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,targetId,targetValue,startDate,dueDate,notes,status,createdAt,updatedAt,userId,goalNote,id);

@override
String toString() {
  return 'GoalEntity(targetId: $targetId, targetValue: $targetValue, startDate: $startDate, dueDate: $dueDate, notes: $notes, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, userId: $userId, goalNote: $goalNote, id: $id)';
}
...
/// Create a copy of GoalEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? targetId = null,Object? targetValue = null,Object? startDate = null,Object? dueDate = freezed,Object? notes = freezed,Object? status = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? userId = null,Object? goalNote = freezed,Object? id = freezed,}) {
...
as int,goalNote: freezed == goalNote ? _self.goalNote : goalNote // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'target_id')  int targetId, @JsonKey(name: 'target_value')  double targetValue, @JsonKey(name: 'start_date')  DateTime startDate, @JsonKey(name: 'due_date')  DateTime? dueDate,  String? notes, @JsonKey(name: 'status')  GoalStatus status, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'user_id')  int userId,  String? goalNote,  int? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GoalEntity() when $default != null:
return $default(_that.targetId,_that.targetValue,_that.startDate,_that.dueDate,_that.notes,_that.status,_that.createdAt,_that.updatedAt,_that.userId,_that.goalNote,_that.id);case _:
  return orElse();
...
//a optional Note
@override final  String? goalNote;
...
/// Create a copy of GoalEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? targetId = null,Object? targetValue = null,Object? startDate = null,Object? dueDate = freezed,Object? notes = freezed,Object? status = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? userId = null,Object? goalNote = freezed,Object? id = freezed,}) {

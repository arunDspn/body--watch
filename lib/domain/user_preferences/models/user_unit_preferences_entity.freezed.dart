...
// required int id,
  ...
  $UserUnitPreferencesEntityCopyWith<UserUnitPreferencesEntity> get copyWith =>
      _$UserUnitPreferencesEntityCopyWithImpl<UserUnitPreferencesEntity>(
          this as UserUnitPreferencesEntity, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UserUnitPreferencesEntity &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, preferredUnit, metricCode);
...
abstract mixin class $UserUnitPreferencesEntityCopyWith<$Res> {
  factory $UserUnitPreferencesEntityCopyWith(UserUnitPreferencesEntity value,
          $Res Function(UserUnitPreferencesEntity) _then) =
      _$UserUnitPreferencesEntityCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'user_id') int userId,
      @JsonKey(name: 'preferred_unit') String preferredUnit,
    ...
    return _then(_self.copyWith(
      userId: null == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as int,
      preferredUnit: null == preferredUnit
          ? _self.preferredUnit
...
extension UserUnitPreferencesEntityPatterns on UserUnitPreferencesEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UserUnitPreferencesEntity value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UserUnitPreferencesEntity() when $default != null:
        return $default(_that.userId, _that.preferredUnit, _that.metricCode);
      case _:
        return orElse();
    }
  }
...
class _UserUnitPreferencesEntity implements UserUnitPreferencesEntity {
  const _UserUnitPreferencesEntity(
      {@JsonKey(name: 'user_id') required this.userId,
      @JsonKey(name: 'preferred_unit') required this.preferredUnit,
      @JsonKey(name: 'metric_code') required this.metricCode});
  factory _UserUnitPreferencesEntity.fromJson(Map<String, dynamic> json) =>
...
// required int id,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserUnitPreferencesEntityCopyWith<_UserUnitPreferencesEntity>
      get copyWith =>
          __$UserUnitPreferencesEntityCopyWithImpl<_UserUnitPreferencesEntity>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UserUnitPreferencesEntityToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UserUnitPreferencesEntity &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.preferredUnit, preferredUnit) ||
                other.preferredUnit == preferredUnit) &&
            (identical(other.metricCode, metricCode) ||
...
/// @nodoc
abstract mixin class _$UserUnitPreferencesEntityCopyWith<$Res>
    implements $UserUnitPreferencesEntityCopyWith<$Res> {
  factory _$UserUnitPreferencesEntityCopyWith(_UserUnitPreferencesEntity value,
          $Res Function(_UserUnitPreferencesEntity) _then) =
      __$UserUnitPreferencesEntityCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'user_id') int userId,

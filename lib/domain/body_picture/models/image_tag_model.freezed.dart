...
mixin _$ImageTagModel {
 ...
 int get id; String get tag;
/// Create a copy of ImageTagModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ImageTagModelCopyWith<ImageTagModel> get copyWith => _$ImageTagModelCopyWithImpl<ImageTagModel>(this as ImageTagModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ImageTagModel&&(identical(other.id, id) || other.id == id)&&(identical(other.tag, tag) || other.tag == tag));
}
...
abstract mixin class $ImageTagModelCopyWith<$Res>  {
  factory $ImageTagModelCopyWith(ImageTagModel value, $Res Function(ImageTagModel) _then) = _$ImageTagModelCopyWithImpl;
@useResult
$Res call({
 int id, String tag
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ImageTagModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ImageTagModel value)  $default,){
final _that = this;
switch (_that) {
case _ImageTagModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ImageTagModel value)?  $default,){
final _that = this;
switch (_that) {
case _ImageTagModel() when $default != null:
return $default(_that);case _:
...
class _ImageTagModel implements ImageTagModel {
  ...
  factory _ImageTagModel.fromJson(Map<String, dynamic> json) => _$ImageTagModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$ImageTagModelCopyWith<_ImageTagModel> get copyWith => __$ImageTagModelCopyWithImpl<_ImageTagModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ImageTagModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ImageTagModel&&(identical(other.id, id) || other.id == id)&&(identical(other.tag, tag) || other.tag == tag));
}
...
/// @nodoc
abstract mixin class _$ImageTagModelCopyWith<$Res> implements $ImageTagModelCopyWith<$Res> {
  factory _$ImageTagModelCopyWith(_ImageTagModel value, $Res Function(_ImageTagModel) _then) = __$ImageTagModelCopyWithImpl;
@override @useResult
$Res call({
 int id, String tag
});

...
/// Tag ID associated with the image
 int get tagId;/// Tag associated with the image
 String get tag;/// Targets (muscle groups) associated with the image
...
$SaveVaultImageRequestCopyWith<SaveVaultImageRequest> get copyWith => _$SaveVaultImageRequestCopyWithImpl<SaveVaultImageRequest>(this as SaveVaultImageRequest, _$identity);
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SaveVaultImageRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SaveVaultImageRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SaveVaultImageRequest value)?  $default,){
final _that = this;
switch (_that) {
case _SaveVaultImageRequest() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$SaveVaultImageRequestCopyWith<_SaveVaultImageRequest> get copyWith => __$SaveVaultImageRequestCopyWithImpl<_SaveVaultImageRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SaveVaultImageRequestToJson(this, );
}
...
/// @nodoc
abstract mixin class _$SaveVaultImageRequestCopyWith<$Res> implements $SaveVaultImageRequestCopyWith<$Res> {

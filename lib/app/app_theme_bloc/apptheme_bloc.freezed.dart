...
$AppthemeEventCopyWith<AppthemeEvent> get copyWith => _$AppthemeEventCopyWithImpl<AppthemeEvent>(this as AppthemeEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppthemeEvent&&(identical(other.appTheme, appTheme) || other.appTheme == appTheme));
}
...
abstract mixin class $AppthemeEventCopyWith<$Res>  {
  factory $AppthemeEventCopyWith(AppthemeEvent value, $Res Function(AppthemeEvent) _then) = _$AppthemeEventCopyWithImpl;
@useResult
$Res call({
 AppTheme appTheme
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AppThemeEventChangeTheme value)?  changeTheme,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AppThemeEventChangeTheme value)  changeTheme,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AppThemeEventChangeTheme value)?  changeTheme,}){
final _that = this;
switch (_that) {
case AppThemeEventChangeTheme() when changeTheme != null:
return changeTheme(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( AppTheme appTheme)?  changeTheme,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AppThemeEventChangeTheme() when changeTheme != null:
return changeTheme(_that.appTheme);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( AppTheme appTheme)  changeTheme,}) {final _that = this;
switch (_that) {
case AppThemeEventChangeTheme():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( AppTheme appTheme)?  changeTheme,}) {final _that = this;
switch (_that) {
case AppThemeEventChangeTheme() when changeTheme != null:
return changeTheme(_that.appTheme);case _:
  return null;
...
@pragma('vm:prefer-inline')
$AppThemeEventChangeThemeCopyWith<AppThemeEventChangeTheme> get copyWith => _$AppThemeEventChangeThemeCopyWithImpl<AppThemeEventChangeTheme>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppThemeEventChangeTheme&&(identical(other.appTheme, appTheme) || other.appTheme == appTheme));
}
...
/// @nodoc
abstract mixin class $AppThemeEventChangeThemeCopyWith<$Res> implements $AppthemeEventCopyWith<$Res> {
  factory $AppThemeEventChangeThemeCopyWith(AppThemeEventChangeTheme value, $Res Function(AppThemeEventChangeTheme) _then) = _$AppThemeEventChangeThemeCopyWithImpl;
@override @useResult
$Res call({
 AppTheme appTheme
});

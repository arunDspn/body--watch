...
extension CreatePasswordStatePatterns on CreatePasswordState {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(CreatePasswordStateInitial value)? initial,
    TResult Function(CreatePasswordStateLoading value)? loading,
    TResult Function(CreatePasswordStateSuccess value)? success,
    TResult Function(CreatePasswordStateFailed value)? failed,
    ...
    switch (_that) {
      ...
      case CreatePasswordStateLoading() when loading != null:
        return loading(_that);
      case CreatePasswordStateSuccess() when success != null:
        return success(_that);
      case CreatePasswordStateFailed() when failed != null:
        return failed(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(CreatePasswordStateInitial value) initial,
    required TResult Function(CreatePasswordStateLoading value) loading,
    required TResult Function(CreatePasswordStateSuccess value) success,
    required TResult Function(CreatePasswordStateFailed value) failed,
  }) {
    final _that = this;
    switch (_that) {
      case CreatePasswordStateInitial():
        return initial(_that);
      case CreatePasswordStateLoading():
        return loading(_that);
      case CreatePasswordStateSuccess():
        return success(_that);
      case CreatePasswordStateFailed():
        return failed(_that);
    }
  }

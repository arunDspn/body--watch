...
extension LoadPicturesStatePatterns on LoadPicturesState {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(LoadPicturesStateLoading value)? loading,
    TResult Function(LoadPicturesStateLoaded value)? loaded,
    TResult Function(LoadPicturesStateFailed value)? failed,
    ...
    switch (_that) {
      ...
      case LoadPicturesStateLoaded() when loaded != null:
        return loaded(_that);
      case LoadPicturesStateFailed() when failed != null:
        return failed(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(LoadPicturesStateLoading value) loading,
    required TResult Function(LoadPicturesStateLoaded value) loaded,
    required TResult Function(LoadPicturesStateFailed value) failed,
  }) {
    final _that = this;
    switch (_that) {
      case LoadPicturesStateLoading():
        return loading(_that);
      case LoadPicturesStateLoaded():
        return loaded(_that);
      case LoadPicturesStateFailed():
        return failed(_that);
    }
  }

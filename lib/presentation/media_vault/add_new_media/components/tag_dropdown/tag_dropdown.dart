...
//   List<ImageTagModel> _orginalTags = [];
//   List<ImageTagModel> _filteredTags = [];

//   // getter
//   List<ImageTagModel> get tags => _filteredTags;
...
//           .where(
//             (element) =>
//                 element.tag.toLowerCase().contains(keyword.toLowerCase()),
//           )
//           .toList();

//       if (newtags.isEmpty) {
//         _filteredTags = [
//           ImageTagModel(tag: 'Add "$keyword" as a new tag', id: null)
//         ];
//       } else {
...
//             (e) => MenuItemButton(
//               onPressed: () {
//                 if (e.tag.contains('" as a new tag')) {

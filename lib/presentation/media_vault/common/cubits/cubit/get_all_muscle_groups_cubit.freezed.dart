...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetAllMuscleGroupsState);
}
...
$GetAllMuscleGroupsStateCopyWith(GetAllMuscleGroupsState _, $Res Function(GetAllMuscleGroupsState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String cause)?  failure,TResult Function( List<String> muscleGroups)?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Failure() when failure != null:
return failure(_that.cause);case _Success() when success != null:
return success(_that.muscleGroups);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String cause)  failure,required TResult Function( List<String> muscleGroups)  success,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Failure():
return failure(_that.cause);case _Success():
return success(_that.muscleGroups);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String cause)?  failure,TResult? Function( List<String> muscleGroups)?  success,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Failure() when failure != null:
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $GetAllMuscleGroupsStateCopyWith<$Res> {
...
class _Success implements GetAllMuscleGroupsState {
  const _Success(final  List<String> muscleGroups): _muscleGroups = muscleGroups;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&const DeepCollectionEquality().equals(other._muscleGroups, _muscleGroups));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_muscleGroups));
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $GetAllMuscleGroupsStateCopyWith<$Res> {
...
/// Create a copy of GetAllMuscleGroupsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? muscleGroups = null,}) {
  return _then(_Success(
null == muscleGroups ? _self._muscleGroups : muscleGroups // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
